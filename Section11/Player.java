...
public class Player implements ISaveable {
    ...
    public void read(List<String> savedItem) {
        if (savedItem != null && savedItem.size() > 0) {
            ...
            hitPoints = Integer.parseInt(savedItem.get(1));
            strength = Integer.parseInt(savedItem.get(2));
    ...
    public String toString() {
        return """
                Player{name='%s', hitPoints=%d, strength=%d, weapon='%s'}""".formatted(name, hitPoints, strength, weapon);
    }
}
